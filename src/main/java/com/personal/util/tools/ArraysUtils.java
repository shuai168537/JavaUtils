...
public class ArraysUtils {
    ...
    /**
     * 判断两个数组是否具有相同的长度，如果数组为null，则被看作长度为0
     *
     * @param array1 数组1
     * @param array2 数组2
    ...
    /**
     * 在数组中查找一个元素，如果未找到或数组为null，则返回-1。
     *
     * @param array        要扫描的数组
     * @param objectToFind 要查找的元素
     * @return 该元素在数组中的序号，如果数组为null或未找到，则返回-1
     */
     ...
     * @return 该元素序列在数组中的序号，如果数组为null或未找到，则返回-1
     */
    ...
    /**
     * 在数组中查找一个元素。如果未找到或数组为null，则返回-1。 起始索引小于0，则看作0，超出数组长度的起始索引则返回-1。
     *
     * @param array        要扫描的数组
     * @param objectToFind 要查找的元素
    ...
    /**
     * 在数组中从末尾开始查找一个元素。如果未找到或数组为null，则返回-1。
     *
     * @param array        要扫描的数组
     * @param objectToFind 要查找的元素
     * @return 该元素在数组中的序号，如果数组为null或未找到，则返回-1
    ...
    /**
     * 在数组中从末尾开始查找一个元素序列。如果未找到或数组为null，则返回-1。
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @return 该元素序列在数组中的序号，如果数组为null或未找到，则返回-1
    ...
    /**
     * 在数组中从末尾开始查找一个元素。如果未找到或数组为null，则返回-1。 起始索引小于0，则看作0，超出数组长度的起始索引则从数组末尾开始找。
     *
     * @param array        要扫描的数组
     * @param objectToFind 要查找的元素
     * @param startIndex   起始索引
    ...
    /**
     * 判断指定对象是否存在于指定数组中，如果数组为null，则返回false
     *
     * @param array        要扫描的数组
     * @param objectToFind 要查找的元素
     * @return 如果找到则返回true
    ...
    /**
     * 判断指定元素序列是否存在于指定数组中，如果数组为null，则返回false
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @return 如果找到则返回true
     ...
     * @return 该元素在数组中的序号，如果数组为null，或未找到，则返回-1。
     */
    ...
    /**
     * 在数组中查找一个元素序列。如果未找到或数组为null，则返回-1。
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @return 该元素在数组中的序号，如果数组为null，或未找到，则返回-1。
    ...
    /**
     * 在数组中查找一个元素序列。如果未找到或数组为null，则返回-1。 起始索引小于0，则看作0，超出数组长度的起始索引则返回-1。
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @param startIndex  起始索引
     * @return 该元素序列在数组中的序号，如果数组为null，或未找到，则返回-1。
     */
    ...
    /**
     * 在数组中从末尾开始查找一个元素。 如果未找到或数组为null则返回-1。
     *
     * @param array      要扫描的数组
     * @param longToFind 要查找的元素
     * @return 该元素在数组中的序号，如果数组为null或未找到，则返回-1。
    ...
    /**
     * 在数组中从末尾开始查找一个元素序列。 如果未找到或数组为null则返回-1。
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @return 该元素序列在数组中的序号，如果数组为null或未找到，则返回-1。
    ...
    /**
     * 在数组中从末尾开始查找一个元素序列。如果未找到或数组为null，则返回-1。起始索引小于0，则返回-1，超出数组长度则从数组末尾开始找
     *
     * @param array       要扫锚的数组
     * @param arrayToFind 要查找的元素序列
     * @param startIndex  起始索引
    ...
    /**
     * 在数组中查找一个元素序列。 如果未找到或数组为null则返回-1。
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @return 该元素序列在数组中的序号，如果数组为null或未找到，则返回-1。
    ...
    /**
     * 在数组中查找一个元素。 如果未找到或数组为null则返回-1。 起始索引小于0则看作0，超出数组长度的起始索引则返回-1。
     *
     * @param array      要扫描的数组
     * @param intToFind  要查找的元素
     * @param startIndex 起始索引
    ...
    /**
     * 在数组中查找一个元素序列。 如果未找到或数组为null则返回-1。 起始索引小于0则看作0，超出数组长度的起始索引则返回-1。
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @param startIndex  起始索引
    ...
    /**
     * 在数组中从末尾开始查找一个元素。 如果未找到或数组为null则返回-1。 起始索引小于0则返回-1，超出数组长度的起始索引则从数组末尾开始找。
     *
     * @param array      要扫描的数组
     * @param intToFind  要查找的元素
     * @param startIndex 起始索引
    ...
    /**
     * 在数组中从末尾开始查找一个元素序列。 如果未找到或数组为null则返回-1。 起始索引小于0则返回-1，超出数组长度的起始索引则从数组末尾开始找。
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @param startIndex  起始索引
    ...
    /**
     * 判断指定对象是否存在于指定数组中。 如果数组为null则返回false。
     *
     * @param array     要扫描的数组
     * @param intToFind 要查找的元素
     * @return 如果找到则返回true
    ...
    /**
     * 判断指定元素序列是否存在于指定数组中。 如果数组为null则返回false。
     *
     * @param array       要扫描的数组
     * @param arrayToFind 要查找的元素序列
     * @return 如果找到则返回true
